...
WebUI.uploadFile(findTestObject('2.Job_Title_Feature/Add Job Title/Input'), GlobalVariable.bigfile)
...
WebUI.verifyElementPresent(findTestObject('2.Job_Title_Feature/Add Job Title/Attachment Size Exceeded'), 10)
