...
WebUI.callTestCase(findTestCase('1.User_Management_Feature/Add New Account/Add New User'), [('Index_Role') : 3, ('Index_Status') : 2
        , ('Employee_Name') : 'Alice', ('Username') : Username, ('Password') : 'Password1!', ('Confirm_Password') : 'Password1!'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('1.User_Management_Feature/Search_Users/Search User'), [('Username') : Username], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('1.User_Management_Feature/AddUser/span_No Records Found'), 0)
