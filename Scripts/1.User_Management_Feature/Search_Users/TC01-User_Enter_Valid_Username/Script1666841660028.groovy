...
WebUI.setText(findTestObject('1.User_Management_Feature/Admin/Username_Input'), setuser)

WebUI.click(findTestObject('1.User_Management_Feature/Admin/Search_Button'))

WebUI.verifyElementPresent(findTestObject('1.User_Management_Feature/Admin/div_Alice.Duval', [('Username') : setuser]), 
