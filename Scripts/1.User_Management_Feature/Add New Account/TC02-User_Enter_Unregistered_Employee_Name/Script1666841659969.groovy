...
WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Employee_Name'), 'Admiz')

WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Username'), 'Katesz')

WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Password'), 'Password1!')

WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Confirm_Password'), 'Password1!')

WebUI.click(findTestObject('1.User_Management_Feature/AddUser/button_Save'))

WebUI.verifyElementPresent(findTestObject('1.User_Management_Feature/AddUser/Invalid_Employee_Name'), 10)
