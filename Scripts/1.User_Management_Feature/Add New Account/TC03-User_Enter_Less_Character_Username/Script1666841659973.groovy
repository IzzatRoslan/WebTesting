...
WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Username'), 'Bob')
...
WebUI.verifyElementPresent(findTestObject('1.User_Management_Feature/AddUser/span_Should be least 5 characters'), 10)
