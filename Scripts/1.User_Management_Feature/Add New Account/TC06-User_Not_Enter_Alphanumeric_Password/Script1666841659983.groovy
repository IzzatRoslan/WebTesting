...
WebUI.setText(findTestObject('1.User_Management_Feature/AddUser/Confirm_Password'), 'Password')

WebUI.click(findTestObject('1.User_Management_Feature/AddUser/button_Save'))

WebUI.verifyElementPresent(findTestObject('1.User_Management_Feature/AddUser/span_Your password must contain a lower-case letter, an upper-case letter, a digit and a special character. Try a different password'), 
    10)
